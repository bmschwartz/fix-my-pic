...
/**
 * @title BasePictureRequestFactory
 * @dev Factory contract to create and manage picture requests.
 */
contract BasePictureRequestFactory is Initializable {
   ...
   */
  function getPictureRequests() public view virtual returns (address[] memory) {
