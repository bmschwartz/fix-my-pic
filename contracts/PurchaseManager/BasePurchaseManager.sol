...
/**
 * @title BasePurchaseManager
 * @dev Manages purchases of request submissions.
 */
contract BasePurchaseManager is Initializable, ReentrancyGuardUpgradeable {
  struct Purchase {
    address buyer;
    uint256 price;
  ...
  function purchaseSubmission(address submissionAddress) public payable virtual nonReentrant {
  ...
  function getPurchases(address user) public view virtual returns (Purchase[] memory) {
